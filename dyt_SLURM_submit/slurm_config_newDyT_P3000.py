...
config.stageoutDir = '/nfs/user/ccaputo/DyT/RECO/CMSSW_10_6_0_pre4-Barrel/MuonGunP3000/job_array_${SLURM_ARRAY_JOB_ID}'
...
inputFiles = glob.glob('/storage/data/cms/store/user/ccaputo/DyT_MuonPGun/SingleMuonP3000_pythia8/DIGI_CMSSW_10_6_X_phase1_2018_realistic_step2_NoPU/190503_221420/000*/output_*.root')
