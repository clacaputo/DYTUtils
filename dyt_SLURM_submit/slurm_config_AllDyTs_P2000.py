...
config.inputSandboxContent = ['run_the_matrix_RECO.sh']
...
config.stageoutDir = '/nfs/user/ccaputo/DyT/RECO/CMSSW_10_6_0_pre4-OnlyBarrel/MuonGunP2000/job_array_${SLURM_ARRAY_JOB_ID}'
...
config.payload = \
"""
./run_the_matrix_RECO.sh ${inputFile} ${outputFile}
"""
