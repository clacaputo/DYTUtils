...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_'+obj.tag+'.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_inMINIAODSIM_'+obj.tag+'.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_inDQM_'+obj.tag+'.root'),
...
process.DYTAnalyzer = cms.EDAnalyzer('DYTAnalyzer',
                              psim = cms.double(1000),
                              useSelections = cms.bool(False)
                              )
