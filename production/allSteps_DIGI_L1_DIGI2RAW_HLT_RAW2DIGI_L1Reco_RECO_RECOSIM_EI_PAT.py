...
# with command line options: allSteps --conditions auto:phase1_2018_realistic -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2018,RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT --datatier MINIAODSIM -n 100 --geometry DB:Extended --era Run2_2018 --eventcontent MINIAODSIM --filein file:step1.root --fileout file:all_step.root --no_exec --runUnscheduled
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('allSteps nevts:100'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:all_step.root'),
