...
# with command line options: step3 -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --conditions auto:phase1_2018_realistic --datatier GEN-SIM-RECO -n 10 --eventcontent RECOSIM --geometry DB:Extended --era Run2_2018 --no_exec
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PAT.root'),
